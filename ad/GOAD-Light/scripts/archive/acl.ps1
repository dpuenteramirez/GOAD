...
SetAcl (Get-ADUser "kiko.lopez") (Get-ADUser "carla.lopez") "GenericAll" "None"
...
SetAcl (Get-ADUser "lord.vega") (Get-ADGroup "Domain Admins") "GenericAll" "None"
...
SetAcl (Get-ADUser "sandra.perez") (Get-ADComputer "dynamo-dc01") "GenericAll" "None"
...
SetAcl (Get-ADUser "particio.burguense") (Get-ADGroup "Domain Admins") "WriteProperty" "All"
...
SetAclExtended (Get-ADUser "daniel.lopez") (Get-ADGroup "Domain Admins") "Self" "bf9679c0-0de6-11d0-a285-00aa003049e2" "None"
...
SetAclExtended (Get-ADUser "sandra.perez") (Get-ADGroup "Domain Admins") "WriteProperty" "bf9679c0-0de6-11d0-a285-00aa003049e2" "All"
...
SetAclExtended (Get-ADUser "kiko.lopez") (Get-ADUser "jaime.lopez") "ExtendedRight" "00299570-246d-11d0-a768-00aa006e0529" "None"
...
SetAcl (Get-ADUser "maestro.paellero") (Get-ADGroup "Domain Admins") "WriteOwner" "None"
...
SetAcl (Get-ADUser "jaime.lopez") (Get-ADUser "carla.lopez") "GenericWrite" "None"
